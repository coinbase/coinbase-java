...
/**
 * API Interface for Buys, Sells, Deposits and Withdrawals
 *
 * @param <T> trade type
...
public interface TradesApi<T extends Trade> {
    ...
    ApiCall<PagedResponse<Trade>> listTrades(
    ...
    ApiCall<CoinbaseResponse<Trade>> showTrade(
            @Path("account_id") String accountId,
            @Path("trade_type") String tradeType,
    ...
    ApiCall<CoinbaseResponse<Trade>> placeTradeOrder(
            @Path("account_id") String accountId,
            @Path("trade_type") String tradeType,
    ...
    ApiCall<CoinbaseResponse<Trade>> commitTradeOrder(
            @Path("account_id") String accountId,
            @Path("trade_type") String tradeType,
            @Path("trade_id") String tradeId,
            @Query("expand[]") Set<String> expandOptions);

...
/**
 * Rx API interface for transactions.
 *
...
public interface TransactionsApiRx {
    ...
    Single<PagedResponse<Transaction>> listTransactions(
    ...
    Single<CoinbaseResponse<Transaction>> showTransaction(
            @Path("account_id") String accountId,
    ...
    Single<CoinbaseResponse<Transaction>> sendMoney(
            @Path("account_id") String accountId,
    ...
    @POST(ApiConstants.ACCOUNTS + "/{account_id}/" + ApiConstants.TRANSACTIONS)
    Single<CoinbaseResponse<Transaction>> requestMoney(
            @Path("account_id") String accountId,
    ...
    Single<CoinbaseResponse<Transaction>> completeMoneyRequest(
            @Path("account_id") String accountId,
            @Path("transaction_id") String transactionId,
            @Query("expand[]") Set<String> expandOptions
    );
    ...
    Single<CoinbaseResponse<Transaction>> resendMoneyRequest(
            @Path("account_id") String accountId,
            @Path("transaction_id") String transactionId,
            @Query("expand[]") Set<String> expandOptions
    );
    ...
    Single<CoinbaseResponse<Void>> cancelMoneyRequest(
            @Path("account_id") String accountId,
            @Path("transaction_id") String transactionId
    );
}

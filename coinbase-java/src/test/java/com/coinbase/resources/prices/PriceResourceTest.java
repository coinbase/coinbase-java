...
import static com.coinbase.resources.prices.PriceResourceTest.*;
import static org.assertj.core.api.AssertionsForClassTypes.assertThat;

/**
 * Tests for Price resource methods.
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({
        BuyPriceTest.class,
...
public interface PriceResourceTest {
    ...
    class BuyPriceTest extends ResourceMethodTest<PricesResource, Price> {
        ...
        protected void requestCheck(RecordedRequest request) {
            final String path = ApiConstants.PRICES + "/" + BASE_CURRENCY + "-" + FIAT_CURRENCY + "/" + ApiConstants.BUY;
    ...
    class SellPriceTest extends ResourceMethodTest<PricesResource, Price> {
        ...
        @Override
        protected void requestCheck(RecordedRequest request) {
            final String path = ApiConstants.PRICES + "/" + BASE_CURRENCY + "-" + FIAT_CURRENCY + "/" + ApiConstants.SELL;
            assertThat(request.getPath()).endsWith(path);
        }
    ...
    class SpotPriceTest extends ResourceMethodTest<PricesResource, Price> {
        ...
        @Override
        protected void requestCheck(RecordedRequest request) {
            final String path = ApiConstants.PRICES + "/" + BASE_CURRENCY + "-" + FIAT_CURRENCY
                    + "/" + ApiConstants.SPOT;
            assertThat(request.getPath()).endsWith(path);
        }
    ...
    class SpotPriceWithDateTest extends ResourceMethodTest<PricesResource, Price> {
        ...
        protected void requestCheck(RecordedRequest request) {
            ...
            final String path = ApiConstants.PRICES
    ...
    class SpotPricesTest extends ResourceMethodTest<PricesResource, List<Price>> {
        ...
        @Override
        protected void requestCheck(RecordedRequest request) {
            final String path = ApiConstants.PRICES + "/" + FIAT_CURRENCY + "/" + ApiConstants.SPOT;
            assertThat(request.getPath()).endsWith(path);
        }
